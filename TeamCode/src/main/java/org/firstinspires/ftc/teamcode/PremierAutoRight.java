...
@Autonomous(name="PremierAutoRight_v4", group = "Concept")
public class PremierAutoRight extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        if (opModeIsActive()) {
            ...
            robot.timeOut(.5);
            robot.strafeRight(28,0.7);
            robot.timeOut(.5);
            robot.driveBackward(106,0.7);
            robot.timeOut(.5);
//            robot.driveForward(100,0.7);
//            robot.timeOut(.5);
